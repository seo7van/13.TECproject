...
public class FaqService {
    ...
    /**
    * FAQ를 저장, 관리자만 저장가능
    * @param faq 추가하려는 FAQ 정보
    * @param username 토큰에서 꺼낸 사용자 이름
    * @return 저장된 FAQ 정보
    */
...
//    // 모든 FAQ 조회
//    public List<Faq> getAllFaqs(String username) {
//        User user = userrepository.findByUsername(username)
//            .orElseThrow(() -> new IllegalArgumentException("사용자를 찾을 수 없습니다."));
//
//        if (!"ROLE_ADMIN".equals(user.getUserType())) {
//            throw new SecurityException("관리자 권한이 필요합니다.");
//        }
//
//        return faqrepository.findAllByIsDeleted("N");
//    }
